...
<template>
  <div class="auth-layout">
    <div class="auth-card">
      ...
      <section v-if="state === 0" class="auth-verify-body">
        <h2 class="auth-title">Forget your password</h2>
        <p class="auth-subtitle">Enter your email to change password</p>
        ...
        <Button @click="handleForgotPassword()" label="Continue" class="btn-primary w-full"/>

        <p class="signin-link">
          Want to login?
          <RouterLink to="/login" class="link-black font-bold">Go back</RouterLink>
        </p>

      </section>
      <section v-else class="auth-verify-body">
        ...
        <p class="signin-link">
          Wrong email?
          <RouterLink to="/forgot" class="link-black font-bold">Go back</RouterLink>
        </p>
      </section>
